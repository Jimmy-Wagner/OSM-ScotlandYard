...
import DataManipulation.BO.IntersectionFinderNew;
...
import HelperClasses.ValueSelector;
...
public class Network {
    ...
    private void fillGraph(SimpleWeightedGraph<Integer, DefaultWeightedEdge> graph){
        ...
        for (SegmentBoNew seg: segments) {
            ...
            if (addedNodes.contains(id1) || addedNodes.contains(id2)){
        ...
        List<Integer> connections = Graphs.neighborListOf(graph, 52586);
    }
    ...
    public void addToSegmentList(ReducedWay way){
        ...
        for (SegmentStroke segmentStroke: segmentStrokes){
            ...
            if (segmentStroke.getIdStartNode() == 1453718 || segmentStroke.getIdEndNode() == 1453718){
